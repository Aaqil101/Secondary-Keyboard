 ...
 */
WIFI(ww_icon, on_off_png, wifi_connecting, wifi_connexion, wifi_disconnect, ms_availablenetworks) {
    ...
    button1.SetColor("c5757c", "FBFADA", 0, 0, 9)
    ...
    button2.SetColor("c5757c", "FBFADA", 0, 0, 9)
    ...
    button3.SetColor("c5757c", "FBFADA", 0, 0, 9)
    ...
    button4.SetColor("462037", "FBFADA", 0, 0, 9)
    ...
    WinSetTransparent(250, "Wifi Selection")

    ; This code block waits for the wcGui window to appear
    WinWait("Wifi Selection")

    ; Get the width and height of the wcGui window
    window_width := 400
    window_height := 145
